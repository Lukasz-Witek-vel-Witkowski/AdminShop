...
public class Fragment_option extends BaseFragment implements View.OnClickListener {
    ...
    private void findViews(View view) {
        ...
        News = view.findViewById(R.id.ib_news_main_option);
        Message = view.findViewById(R.id.ib_massage_main_option);
        Add = view.findViewById(R.id.ib_add_main_option);
        Option = view.findViewById(R.id.ib_option_main_option);
    }
